...
use crate::history::{
    HistoryGraph, HistoryId, HistoryNode, HistoryNodeBinarize, HistoryNodeEliminateNulling,
};
...
impl Cfg {
    ...
    pub fn binarize_and_eliminate_nulling_rules(&mut self) -> Cfg {
        ...
        self.populate_and_get_rhs_cache().rhs_closure(&mut nullable);
    ...
    #[inline]
    fn with_symbol_source_and_history_graph(sym_source: SymbolSource, history_graph: HistoryGraph) -> Self {
        Cfg {
            sym_source,
            history_graph,
            ..Default::default()
    ...
    fn add_multiple_history_nodes(&mut self, nodes: impl AsRef<[]>)
